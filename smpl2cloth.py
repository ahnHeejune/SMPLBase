...
def smpl2cloth3dcore(cam,      # camera model, Chv
    ...
    if use_edge_vertices:
        ...
        print("longest_contour_label:", longest_contour_label)    
                ...
                for v_e in graph[v_s]:
                    ...
                    if graph[v_s][v_e][2] == longest_contour_label:  # > 0:
                        if check_edge_vertices:
                            ...
                            i = i + 1
                        cv2.line(img_contour, (int(sx), int(sy)), (int(ex), int(ey)),
                                    color = 255, thickness=1)
                                 #longest_contour_label, thickness=1)
                                 #graph[v_s][v_e][2], thickness=1)
